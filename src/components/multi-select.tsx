      ...
      <>
        ...
        >
          ...
          <PopoverTrigger asChild>
            ...
            >
              {selectedValues.length > 0 ? (
                <div className="flex w-full items-center justify-between border rounded-md p-2">
                  <div
                    className={cn(
                ...
                <div className="mx-auto flex w-full items-center justify-between border rounded-md p-2">
