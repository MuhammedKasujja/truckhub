...
export interface PriceScheduleFormProps {
  ...
  onSave?: (rows: DistancePricingRequest[], schedule: PriceSchedule, effectiveDate: Date) => void
}
...
const SEED_RATES: RateEntry[] = (
  [
    ["d_0_40", "t_0_2", 2220, 2664],
    ["d_0_40", "t_3_5", 1120, 1344],
    ["d_0_40", "t_6_10", 920, 1104],
    ["d_0_40", "t_11_15", 820, 984],
    ["d_0_40", "t_16_20", 620, 744],
    ["d_0_40", "t_21_25", 520, 624],

    ["d_41_100", "t_0_2", 1150, 1380],
    ["d_41_100", "t_3_5", 1120, 1344],
    ["d_41_100", "t_6_10", 820, 984],
    ["d_41_100", "t_11_15", 720, 864],
    ["d_41_100", "t_16_20", 520, 624],
    ["d_41_100", "t_21_25", 470, 564],

    ["d_101_150", "t_0_2", 1060, 1272],
    ["d_101_150", "t_3_5", 620, 744],
    ["d_101_150", "t_6_10", 570, 684],
    ["d_101_150", "t_11_15", 570, 684],
    ["d_101_150", "t_16_20", 420, 504],
    ["d_101_150", "t_21_25", 400, 480],

    ["d_151_200", "t_0_2", 1060, 1272],
    ["d_151_200", "t_3_5", 590, 708],
    ["d_151_200", "t_6_10", 490, 588],
    ["d_151_200", "t_11_15", 490, 588],
    ["d_151_200", "t_16_20", 400, 480],
    ["d_151_200", "t_21_25", 380, 456],

    ["d_201_300", "t_0_2", 970, 1164],
    ["d_201_300", "t_3_5", 560, 672],
    ["d_201_300", "t_6_10", 470, 564],
    ["d_201_300", "t_11_15", 470, 564],
    ["d_201_300", "t_16_20", 400, 480],
    ["d_201_300", "t_21_25", 370, 444],

    ["d_301_400", "t_0_2", 970, 1164],
    ["d_301_400", "t_3_5", 490, 588],
    ["d_301_400", "t_6_10", 450, 540],
    ["d_301_400", "t_11_15", 450, 540],
    ["d_301_400", "t_16_20", 370, 444],
    ["d_301_400", "t_21_25", 340, 408],

    ["d_401_600", "t_0_2", 920, 1104],
    ["d_401_600", "t_3_5", 470, 564],
    ["d_401_600", "t_6_10", 420, 504],
    ["d_401_600", "t_11_15", 420, 504],
    ["d_401_600", "t_16_20", 370, 444],
    ["d_401_600", "t_21_25", 340, 408],

    ["d_601_up", "t_0_2", 720, 864],
    ["d_601_up", "t_3_5", 420, 504],
    ["d_601_up", "t_6_10", 400, 480],
    ["d_601_up", "t_11_15", 370, 444],
    ["d_601_up", "t_16_20", 340, 408],
    ["d_601_up", "t_21_25", 340, 408],
...
export const rateKey = (
  distanceRangeId: string,
  tonnageRangeId: string
): string => `${distanceRangeId}__${tonnageRangeId}`
...
export const numericLeadingSort: SortingFn<RateEntry> = (
  rowA,
  rowB,
  columnId
) => {
...
export function buildScheduleFromForm(data: FormValues): PriceSchedule {
  ...
  const rates = data.rates
    .filter(
      (r) =>
        distanceIds.has(r.distanceRangeId) && tonnageIds.has(r.tonnageRangeId)
    )
    .map((r) => ({
    ...
    .sort(
      (a, b) =>
        (distanceOrder.get(a.distanceRangeId) ?? 0) -
          (distanceOrder.get(b.distanceRangeId) ?? 0) ||
        (tonnageOrder.get(a.tonnageRangeId) ?? 0) -
          (tonnageOrder.get(b.tonnageRangeId) ?? 0)
    )
...
export function toDbRows(schedule: PriceSchedule): DistancePricingRequest[] {
  ...
  return schedule.rates.map((r) => {
    ...
    if (!d || !t) {
      throw new Error(
        `Rate references a bracket that no longer exists: ${r.distanceRangeId} / ${r.tonnageRangeId}`
      )
    }
    return {
...
export function fromDbRows(rows: DistancePricingRequest[]): PriceSchedule {
  ...
  const distanceRanges = [...distanceByKey.values()].sort(
    (a, b) => a.min - b.min
  )
